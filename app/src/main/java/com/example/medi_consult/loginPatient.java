...
public class loginPatient extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference= FirebaseDatabase.getInstance().getReferenceFromUrl("https://medi-consult-1bad8-default-rtdb.firebaseio.com/Patients/");
    ...
    void submitAppointment(){
        ...
        FirebaseDatabase.getInstance().getReferenceFromUrl("https://medi-consult-1bad8-default-rtdb.firebaseio.com/Appointments/")
                .child(patientId)
